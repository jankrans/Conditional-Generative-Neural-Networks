...
class Clustering:
    ...
    def get_all_superinstance_representatives(self):
        all_representatives = [repr for cluster in self.clusters for repr in cluster.get_all_superinstance_representatives()]
